...
/*
 * typedef cmi_coroutine_exit_func - Prototype for a function to be called on exit
...
/*
 * cmi_coroutine_start - Launch the given coroutine, launching cr_function(cp, context)
