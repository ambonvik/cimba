/*
* tut_5_2.h - Shared model definitions for CPU and CUDA translation units.
 *
 * This header is included by both tut_5_2.c (gcc, C23) and tut_5_2.cu
...
#ifndef CIMBA_TUT_5_2_H
#define CIMBA_TUT_5_2_H
...
/*
 * Noise and terrain generation parameters — must match tut_5_2.c exactly.
 ...
 * terrain_init and terrain_terminate are implemented in tut_5_2.cu;
 * the rest live in tut_5_2.c. Declared with C linkage so nvcc and gcc
